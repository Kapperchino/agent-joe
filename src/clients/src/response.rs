...
impl ToolCall {
    ...
    pub fn content(&self) -> crate::llm::ContentBlock {
        crate::llm::ContentBlock::ToolBlock {
            tool_id: self.id.clone(),
            name: self.name.clone(),
            input: self.input.clone(),
        }
    }
    pub fn error_content(&self, message: &str) -> crate::llm::ContentBlock {
...
pub enum ProcessedItem {
    Content(crate::llm::ContentBlock),
    Tool(ToolCall),
}
